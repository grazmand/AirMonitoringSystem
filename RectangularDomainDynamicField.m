classdef RectangularDomainDynamicField  < matlab.mixin.SetGet
    ...
    methods
        function dynamicField(obj, vals)
            ...
            obj.set(props, vals)
            if (obj.endTime > obj.ds.time.time_steps(end)) || (obj.startTime < obj.ds.time.time_steps(1))
