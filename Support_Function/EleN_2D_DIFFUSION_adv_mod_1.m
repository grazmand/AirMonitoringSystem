...
function [Se,Te,Shape,SVe] = EleN_2D_DIFFUSION_adv( Mesh, ie, vel )
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    XY = Mesh.xy(:,Mesh.ele(2:(Mesh.ele(1,ie)+1),ie))';%Mesh.xy(:,Mesh.ele(1:3,ie))';

    switch 3
        case 3
            [Se,Te,Shape,SVe] = EleNT1(XY,vel);
        case 4
            [Se,Te] = EleNQ1(XY);
        case 6
            [Se,Te] = EleNT2(XY);
...
function [Se,Te,Shape,SVe] = EleNT1(XY,vel)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    GN = [Dy(1) Dy(2) Dy(3); Dx(1) Dx(2) Dx(3)];
